...
class WikipediaIndex:
    def __init__(self, wiki_data_dir):
        indexpath = os.path.join(wiki_data_dir, 'knn.index')
        wiki_sentence_path = os.path.join(wiki_data_dir, 'wikipedia-en-sentences.parquet')
