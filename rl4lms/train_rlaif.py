...
from rl4lms.envs.text_generation.registry import DataPoolRegistry, RewardFunctionRegistry
from rl4lms.customized_modules import EmpatheticDialoguesDataPool, EmotionAlignmentRewardFunction
...
def main(
    ...
    RewardFunctionRegistry.add("emotion_alignment", EmotionAlignmentRewardFunction)
