...
IGNORE_INDEX = -100
INSTRUCTION = """\
You are a doctor named Aceso, interact with the speaker, continue the conversation and be empathetic, helpful, and safe.
"""

PROMPT_DICT = (
    "Below is an instruction that describes your role, paired with a dialogue example."
    "Learn the conversation style of the listener from on the dialogue.\n\n"
    "### Instruction:\n{instruction}\n\n### Dialogue:\n{dialogue}"
    )
REMOVE_COLUMNS = ["instruction", "dialogue"]


def generate_prompt(data_point):  
    data_point["instruction"] = INSTRUCTION
    datapoint = PROMPT_DICT.format_map(data_point)
    return datapoint
...
def train(
        ...
        peft_weights_dir: str = "/peft_weights", # this is the weight from SFT
        ...
        # llm hyperparams
        train_on_instructions: bool = True, 
    ...
    if int(os.environ.get("LOCAL_RANK", 0)) == 0:
        print(
            ...
            f"peft_weights_dir: {peft_weights_dir}\n"
            ...
            "llm hyperparams:\n"
            "----------------\n"
            f"train_on_inputs: {train_on_instructions}\n"
    ...
    def generate_and_tokenize_prompt(data_point):
        ...
        if not train_on_instructions:
            user_prompt = generate_prompt({**data_point, "dialogue": ""})
    ...
    if os.path.exists(peft_weights_dir):
        ...
        print("="*50)
        print("Loaded LoRA model resulted from SFT")
    ...
    training_args = TrainingArguments(
        ...
        evaluation_strategy=save_strategy, # align both strategies for the purpose of loading best model at the end
